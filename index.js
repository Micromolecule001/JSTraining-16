...
function compareArrays(arr1, arr2) {
  ...
  if (JSON.stringify(arr1) === JSON.stringify(arr2)) {
    ...
    console.log("Assertion failed: Масиви не однакові!")
  }
...
compareArrays([1, 2, 4, 3, 5], [1, 2, 3, 4]);
...
function buildMatrix(size) {
  ...
  for (let i = 0; i < size; i++) {
    ...
    for (let j = 0; j < size; j++) { row.push(Math.floor(Math.random() * 9) + 1); }
...
function validateUserInput(userInput) {
  if (userInput.username) {
   ...
   else { console.warn("Помилка: ім'я користувача відсутнє!") }
...
function countVowelsAndConsonants(word) {
  ...
  console.log(`Голосних: ${counter1}, Приголосних: ${counter2 - counter1 - 1} `);
